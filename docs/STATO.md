...
- Moltiplicatori di zona e del piano: stime senza fonte, da tarare sui casi. Con il luogo
  ...
  dichiarata.
- **Altezze e giardini**: OpenStreetMap dà le sagome degli edifici ma sul luogo di prova
  nessuna altezza (0 su 478) e quasi nessun giardino (Vomero: 109 altezze su 231, 3
  giardini). Da cercare, tutte da verificare: altezze da dataset aperti mondiali o dal
  LiDAR del Ministero dell'Ambiente, terreno da Tinitaly (INGV), verde da ESA WorldCover o
  dalle foto aeree.
- **Luogo di prova**: un indirizzo vero di Napoli dato da Marcello, in `privato/` (fuori da
  git). Mai nei documenti né nei test.
...
1. **Il luogo in 3D**, primo prototipo sul luogo di prova: gatto che scappa dal primo
   piano. Il nascondiglio si sceglie fra i posti veri alla distanza degli studi. Prima 2-3
   varianti di mappa affiancate (oggi a cerchi; con edifici e giardini; con i dislivelli),
   Marcello sceglie, poi si costruisce.
